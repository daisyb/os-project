...
struct process {
  ...
  bool loaded;                  /* Whether the process has been loaded or not */
  struct  file* executable;     /* Executable to close after run */
...
/* interacts with proecesses */
pid_t thread_add_child_process(tid_t tid);
struct process *thread_get_child_process(pid_t pid);
void remove_and_free_process(struct process *p);
